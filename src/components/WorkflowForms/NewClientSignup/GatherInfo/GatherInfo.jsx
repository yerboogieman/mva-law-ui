...
const GatherInfoForm = ({caseId, setSelectedStep}) => {
   ...
   useEffect(loadProviderTypes, []);

   function loadProviderTypes() {
      setLoading(true);
      api.get_healthcare_provider_types()
         .then((result = {}) => {
      ...
      try {
         ...
         if (Array.isArray(data)) {
            ...
            const errorData = {
               ...
               status: 200,
               detail: 'API response format is neither a direct array nor {success, data: [...]}.',
               instance: '/types/organizations',
               data: data
            };
